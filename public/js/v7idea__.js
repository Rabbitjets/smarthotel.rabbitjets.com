	...
	function editOrder(id) {
	    ...
	    $.ajax({
	        ...
	        success: function(response) {
	            ...
	            $('#editOrderId').text(response.data.id).trigger('change');
	            ...
	            $('#editContactName').text(response.data.contact_name).trigger('change');
	            $('#editContactEmail').text(response.data.contact_email).trigger('change');
	            $('#editContactPhone').text(response.data.contact_mobile).trigger('change');
